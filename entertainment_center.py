...
<<<<<<< HEAD:entertainment_centre.py

api_key = '2b75293ff31f7a9106524c6645e8fb58'
link = 'https://api.themoviedb.org/3/movie/now_playing?api_key=' + \
                api_key + '&page=1&genre=Animation'
=======
api_key = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'
link = 'https://api.themoviedb.org/3/movie/now_playing?api_key=' + api_key + '&page=1&genre=Animation'
>>>>>>> origin/master:entertainment_center.py
